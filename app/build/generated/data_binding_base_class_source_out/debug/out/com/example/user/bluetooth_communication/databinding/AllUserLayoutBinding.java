...
public final class AllUserLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public static AllUserLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AllUserLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.all_user_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AllUserLayoutBinding bind(@NonNull View rootView) {
